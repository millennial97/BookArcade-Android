...
public class FeaturedHomeBook {
    ...
    public FeaturedHomeBook(String book_title, String book_id, String image_url, String book_author, double book_mrp, double book_price, String book_description) {
